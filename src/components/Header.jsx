...
function Header() {
  ...
  return (
    <div className="w-full text-white h-auto md:h-24 items-center md:justify-between justify-center py-4 px-6 md:py-4 md:px-10 bg-transparent fixed top-0 left-0 backdrop-blur-xl z-10 flex ">
      ...
      {hide && (
        <nav className="w-screen flex flex-col md:flex-row items-center justify-evenly text-white h-auto md:h-full bg-[#0b0b0b] rounded-b-2xl md:rounded-none md:bg-transparent backdrop-blur-xl z-10 md:static absolute top-0 left-0 gap-4 py-10 md:hidden">
          <span
