            ...
            <div className="flex flex-row gap-10">
                <div className="w-1/3 ">
                    ...
                    <p className=" w-full py-6 ">
                        <strong> Venue: </strong>{data.event1.venue} <br /> <br />
                        <strong> Timing:</strong> {data.event1.timing}
                    </p>
                </div>
                <div className="w-2/3 text-sm">
                    <h2 className='text-lg font-bold'>
                        {data.event1.mainHeading}
                    </h2>
                    {data.event1.desc}
                    <h2 className={headingStyle}>{data.event1.heading1}</h2>
                    {data.event1.desc1}
                    <h2 className={headingStyle}>{data.event1.heading2}</h2>
                    {data.event1.desc2}
                    <h2 className={headingStyle}>
                        {data.event1.majorHeading2}
                    </h2>
                    <ul>
                        <li className={liStyle}>{data.event1.presentationFormat.one}</li>
                        <li className={liStyle}>{data.event1.presentationFormat.two}</li>
                        <li className={liStyle}>{data.event1.presentationFormat.three}</li>
                        <li className={liStyle}>{data.event1.presentationFormat.four}</li>
                    </ul>
                    <h2 className={headingStyle}>{data.event1.heading3}</h2>
                    {data.event1.desc3}

                    <h2 className={headingStyle}>{data.event1.majorHeading3}</h2>
                    <ul>
                        <li className={liStyle}>{data.event1.topics.one}</li>
                        <li className={liStyle}>{data.event1.topics.two}</li>
                        <li className={liStyle}>{data.event1.topics.three}</li>
                        <li className={liStyle}>{data.event1.topics.four}</li>
                        <li className={liStyle}>{data.event1.topics.five}</li>
                        <li className={liStyle}>{data.event1.topics.six}</li>
                        <li className={liStyle}>{data.event1.topics.seven}</li>
                        <li className={liStyle}>{data.event1.topics.eight}</li>
                        <li className={liStyle}>{data.event1.topics.nine}</li>
                        <li className={liStyle}>{data.event1.topics.ten}</li>
                        <li className={liStyle}>{data.event1.topics.eleven}</li>
                        <li className={liStyle}>{data.event1.topics.twelve}</li>
                        <li className={liStyle}>{data.event1.topics.thirteen}</li>
                        <li className={liStyle}>{data.event1.topics.fourteen}</li>
                        <li className={liStyle}>{data.event1.topics.fifteen}</li>
                        <li className={liStyle}>{data.event1.topics.sixteen}</li>
                        <li className={liStyle}>{data.event1.topics.seventeen}</li>


                    </ul>

                    <h2 className={headingStyle}>{data.event1.majorHeading1}</h2>
                    <ul>
                        <li className={liStyle}>{data.event1.guidlines.one}</li>
                        <li className={liStyle}>{data.event1.guidlines.two}</li>
                        <li className={liStyle}>{data.event1.guidlines.three}</li>
                        <li className={liStyle}>{data.event1.guidlines.four}</li>
                        <li className={liStyle}>{data.event1.guidlines.five}</li>
                        <li className={liStyle}>{data.event1.guidlines.six}</li>
                        <li className={liStyle}>{data.event1.guidlines.seven}</li>
                        <li className={liStyle}>{data.event1.guidlines.eight}</li>
                        <li className={liStyle}>{data.event1.guidlines.nine}</li>
                        <li className={liStyle}>{data.event1.guidlines.ten}</li>
